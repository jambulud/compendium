...
refer to <<page2.asciidoc#, page 2>> for more info

link:./page2.asciidoc[test link with asciidoc]

link:page2.asciidoc[test link ]

link:page2.asciidoc#appcomponent[test sublink in minus with asciidoc]

link:page2#AppComponent.asciidoc[test sublink in mayus before asciidoc]

link:page2#appcomponent.asciidoc[test sublink in minus before asciidoc]
